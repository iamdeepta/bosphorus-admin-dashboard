  ...
  var dzChartlist = (function () {
    ...
    var radialBar2 = function () {
      ...
      var chart = new ApexCharts(
        document.querySelector("#radialBar2"),
        options
      );
      chart.render();
    };
    var radialBar3 = function () {
      ...
      var chart = new ApexCharts(
        document.querySelector("#radialBar3"),
        options
      );
      chart.render();
    };
        ...
        series: [
          {
            name: "New Clients",
            data: [
              70, 20, 75, 20, 50, 40, 65, 15, 40, 55, 60, 20, 75, 40, 25, 70,
              20, 40, 65, 50, 35, 70, 45, 40, 35, 55, 60,
            ],
          },
          {
            ...
            data: [
              ...
              -20, -30, -45, -70, -50, -45, -10, -20, -55, -25, -45, -35, -15,
              -40,
            ],
          },
        ],
    ...
    var chartTimeline2 = function () {
        ...
        series: [
          {
            name: "New Clients",
            data: [
              20, 20, 75, 55, 50, 40, 65, 40, 20, 55, 60, 55, 75, 40, 25, 70,
              20, 40, 65, 50, 35, 70, 45, 40, 35, 55, 60,
            ],
          },
          {
            name: "Retained Clients",
            data: [
              -60, -10, -45, -25, -55, -65, -22, -10, -50, -10, -70, -35, -60,
              -20, -20, -45, -70, -50, -55, -10, -20, -55, -25, -45, -35, -15,
              -40,
            ],
          },
        ],
      ...
      var chartTimelineRender = new ApexCharts(
        document.querySelector("#chartTimeline2"),
        optionsTimeline
      );
      chartTimelineRender.render();
    };
    ...
    var chartTimeline3 = function () {
        ...
        series: [
          {
            name: "New Clients",
            data: [
              50, 10, 55, 35, 45, 30, 55, 25, 35, 42, 55, 60, 50, 45, 30, 65,
              26, 35, 55, 55, 40, 60, 42, 35, 40, 60, 55,
            ],
          },
          {
            name: "Retained Clients",
            data: [
              -50, -20, -45, -33, -35, -55, -30, -20, -30, -10, -45, -40, -55,
              -25, -35, -50, -60, -55, -35, -15, -20, -55, -25, -45, -35, -15,
              -40,
            ],
          },
        ],
      ...
      var chartTimelineRender = new ApexCharts(
        document.querySelector("#chartTimeline3"),
        optionsTimeline
      );
      chartTimelineRender.render();
    };
